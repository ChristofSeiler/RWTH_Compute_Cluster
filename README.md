...
5. Go to your Aachen account [here](https://www.rwth-aachen.de/selfservice) and set passwords for in `Accounts and Passwords` for `Hochleistungsrechnen RWTH Aachen` and `WLAN/VPN`
